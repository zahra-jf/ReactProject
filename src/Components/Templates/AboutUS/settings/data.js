const aboutUsData = [
  {
    id: 1,
    label: "درباره فروشگاه دارچین شاپ",
    content:
  ...
  },
  {
    ...
    content:
      "آدرس اصلی: اصفهان، خیابان چهارباغ پایین، پلاک ۱۲۳۴، طبقه همکف. برای دسترسی آسان، از اپلیکیشن‌های نقشه مانند گوگل مپس یا ویز استفاده کنید. پارکینگ اختصاصی برای مشتریان در دسترس است. شعبه دوم: اصفهان، خ توحید ، پلاک ۵۰۶.",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    content:
      "شماره اصلی: ۰۲۱-۸۸۷۷۶۵۴۳ (خطوط مستقیم). پشتیبانی آنلاین: از طریق چت وبسایت یا واتس‌اپ به شماره ۰۹۱۲-۳۴۵۶۷۸۹. ایمیل: info@darchinshop.ir. تیم پشتیبانی ما ۲۴ ساعته در دسترس است و به سوالات شما در مورد سفارشات، بازگردانی و مشاوره محصولات پاسخ می‌دهد.",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    content:
      "وبسایت: www.darchinshop.ir – قابل دسترسی از تمام مرورگرها با رابط کاربری فارسی و انگلیسی. اپلیکیشن موبایل: دانلود از گوگل پلی و اپ استور (نسخه اندروید ۵.۰+ و iOS ۱۲+). ویژگی‌های اپ: سفارش سریع، نوتیفیکیشن پیشنهادها و پرداخت آنلاین امن.",
  },
];
